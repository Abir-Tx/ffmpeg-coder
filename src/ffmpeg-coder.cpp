...
void ffmpeg::load_encodes() {
    ...
    void ffmpeg::select_audioBitrate() {
        clear_screen();
        int choice;
        int ab1 = 96;
        int ab2 = 128;
    ...
    void ffmpeg::select_videoBitrate() {
        clear_screen();
  ...
  */
    ...
    void ffmpeg::generateCodes(std::string videoEncoding) {
